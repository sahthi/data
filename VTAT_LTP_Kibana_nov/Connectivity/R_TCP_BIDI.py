...
def TCP_BIDI():
	...
	for dev in adb_dev:
		...
		#UL commads
		UL_server_cmd=" gnome-terminal -e 'iperf -s -i 1 '"
		UL_client_cmd=" gnome-terminal -e 'adb -s "+STA_ID+" shell iperf -c "+Server_IP+" -i 1 -t "+Time_limit+" '"
		#DL commads
		DL_server_cmd=" gnome-terminal -e 'adb -s "+STA_ID+" shell iperf -s  -i 1' "
		DL_client_cmd=" gnome-terminal -e 'iperf -c "+STA_IP+" -i 1 -t "+Time_limit+" '"
