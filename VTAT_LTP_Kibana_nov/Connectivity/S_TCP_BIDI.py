...
def SAP_TCP_BIDI():
	...
	for dev in adb_dev:
		if dev != SAP_ID :
			...
			#UL commands
			UL_server_cmd=" gnome-terminal -e 'adb -s "+SAP_ID+" shell iperf -s -i 1 '"
			UL_client_cmd=" gnome-terminal -e 'adb -s "+STA_ID+" shell iperf -c "+SAP_IP+" -i 1 -t "+Time_limit+" '"
			#DL commands
			DL_server_cmd=" gnome-terminal -e 'adb -s "+STA_ID+" shell iperf -s -i 1 '"
			DL_client_cmd=" gnome-terminal -e 'adb -s "+SAP_ID+" shell iperf -c "+STA_IP+" -i 1 -t "+Time_limit+" '"
