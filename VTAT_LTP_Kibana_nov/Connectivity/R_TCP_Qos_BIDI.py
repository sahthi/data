...
def TCP_Qos_BIDI():
	...
	for dev in adb_dev:
		...
		DL_client_cmd1 = " gnome-terminal -e 'iperf -c "+STA_IP+" -i 1 -w 1M -t "+Time_limit+" -S 0x00 -p 6000 '"
		DL_client_cmd2 = " gnome-terminal -e 'iperf -c "+STA_IP+" -i 1 -w 1M -t "+Time_limit+" -S 0x20 -p 6001 '"
		DL_client_cmd3 = " gnome-terminal -e 'iperf -c "+STA_IP+" -i 1 -w 1M -t "+Time_limit+" -S 0xa0 -p 6002 '"
		DL_client_cmd4 = " gnome-terminal -e 'iperf -c "+STA_IP+" -i 1 -w 1M -t "+Time_limit+" -S 0xe0 -p 6003 '"
