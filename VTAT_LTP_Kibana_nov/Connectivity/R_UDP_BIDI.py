...
def UDP_BIDI():
	...
	for dev in adb_dev:
		...
		#UL commads
		UL_server_cmd=" gnome-terminal -e 'iperf -s -u -i 1' "
		UL_client_cmd=" gnome-terminal -e 'iperf -c "+Server_IP+" -u -b "+Band_width+" -i 1 -t "+Time_limit+" '"
		#DL commads
		DL_server_cmd=" gnome-terminal -e 'adb -s "+STA_ID+" shell iperf -s -u -i 1' "
		DL_client_cmd=" gnome-terminal -e 'iperf -c "+STA_IP+" -u -b "+Band_width+" -i 1 -t "+Time_limit+" '"
