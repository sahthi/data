$(document).ready(function(e){
	...
	$('body').delegate("#readme_upload",'submit',function(evnt){

		var data = new FormData($('#readme_upload')[0]);
...
$('body').delegate("#module_execute","click",function(evnt){
	//alert("hello");
	check_array = new Array();
	$("input:checkbox[name=checkedbtns]:checked").each(function(){
    check_array.push($(this).val());
    
	});
	//alert(check_array);
	console.log(check_array);
	var iterations = $("#module_iterations").val();
    console.log(iterations);

    $.ajax({
    	url:"/runPlanExecution/",
    	type:"POST",
    	data:{"module_array":JSON.stringify(check_array),"module_iterations":iterations,"execution":"module"},
    	success:function(response){
    		alert(response);
    	},
    	error:function(response){
...
$('body').delegate("#script_execute","click",function(evnt){
	//alert("running");
	document.getElementById("repo_monitor_execute").click();
	alert("running");
	check_array = new Array();
	$("input:checkbox[name=checkedscripts]:checked").each(function(){
    check_array.push($(this).val());
   ...
   $.ajax({
    	...
    	type:"POST",
    	data:{"module_array":JSON.stringify(check_array),"module_iterations":iterations,"execution":"script"},
    	success:function(response){
    		alert(response);
    	},
    	error:function(response){
	...
	evnt.preventDefault();
	//Query('#modal').click();
	//$("#repo_monitor_execute").click()
	// $("#repo_monitor_execute").click()
});

$('body').delegate("#testype_execute","click",function(evnt){
	//alert("hello");
	check_array = new Array();
	$("input:checkbox[name=checkedtesttype]:checked").each(function(){
    check_array.push($(this).val());
   ...
   $.ajax({
    	url:"/runPlanExecution/",//"/runScriptExecution/",
    	type:"POST",
    	data:{"module_array":JSON.stringify(check_array),"module_iterations":iterations,"execution":"testtypes"},
    	success:function(response){
    		alert(response);
    	},
    	error:function(response){
